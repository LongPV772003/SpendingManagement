...
import 'package:html/dom.dart' as TextHTML;
...
import 'package:spending_management/models/filter.dart' as useFilter;
...
class _SearchPageState extends State<SearchPage> {
  ...
  String? query;
  useFilter.Filter filter =useFilter.Filter(chooseIndex: [0, 0, 0], friends: [], colors: []);

    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(
            "${AppLocalizations.of(context).translate('developed_by')} Pham Van Long Team",
          ),
          const SizedBox(height: 15),
          ...
          InkWell(
            onTap: () async {
              var url = 'https://www.facebook.com/hi.long.nee';
          ...
          InkWell(
            onTap: () async {
              String email = 'Phamvanlong7720033@gmail.com';
          ...
          InkWell(
            onTap: () async {
              var url = 'https://me.momo.vn/PhamVanLong';
              if (await canLaunchUrlString(url)) {
                await launchUrlString(
                  url,
                  mode: LaunchMode.externalApplication,
